...
#define PCLK 5
#define SWIZZLE 2
#define CAL_DEFAULTS 32654, -1409, -686560, 818, -19189, 18375620
#endif
...
void ComProgressbar(int x, int y, int w, int h, int ops, int val, int range);
void ComSlider(int x, int y, int w, int h, int ops, int val, int range);
void ComDial(int x, int y, int r, int ops, int val);
